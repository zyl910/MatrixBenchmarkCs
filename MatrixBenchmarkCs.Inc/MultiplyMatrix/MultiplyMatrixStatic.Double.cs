...
namespace MatrixBenchmarkCs.MultiplyMatrix {
    ...
    partial class MultiplyMatrixStatic {
        ...
        /// <summary>TileRow on SIMD Fma on Bcl.</summary>
        /// <inheritdoc cref="StaticBasic(int, int, int, TMy[], int, TMy[], int, TMy[], int)"/>
...
#if NETCOREAPP3_0_OR_GREATER
        /// <summary>TileRow on SIMD Fma on X86.</summary>
        /// <inheritdoc cref="StaticBasic(int, int, int, TMy[], int, TMy[], int, TMy[], int)"/>
        ...
        /// <summary>Multiply matrix by block - M is 4*Y, N is vectorWidth*1*X - ikj - Block size custom.</summary>
        /// <inheritdoc cref="StaticBasic(int, int, int, TMy[], int, TMy[], int, TMy[], int)"/>
